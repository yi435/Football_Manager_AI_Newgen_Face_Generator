...
class SetupWizard:
    ...
    def _write_config(self):
        ...
        cfg = {
            ...
            "face_style": "candid smartphone camera snapshot medium shot bust portrait of a [AGE]-year-old male [NATIONALITY] football player, [PERSONALITY], head and shoulders, showing upper chest, athletic training shirt, natural lighting, unpolished raw photo, visible skin texture, blurred background, real life photo",
            "concurrency_limit": 1,
